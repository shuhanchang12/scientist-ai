...
def chat_with_papers():
    ...
    #some information
    st.info("Notes: I have not implemented memory 🧠 yet, so include context in all questions asked. Also for best results, ask specific questions about the paper📄. Clear conversation history when you are done.")
